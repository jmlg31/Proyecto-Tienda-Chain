...
<body>
<div id="general"><img id="foto1" src="Imagenes/logo-dacunha1.png" /><p class="titulo">"Especialista en Bicicletas, accesorios y componentes"</p><a class="miCuenta" href="miCuenta.php"><img id="foto2" src="Imagenes/user_3.png"/>Mi Cuenta</a><a class="identificarse" href="identificarse.php"><img id="foto3" src="Imagenes/icon_login.png"/>Identificarse</a>
...
<section class="container">
    <div class="login">
      ...
      <form method="post" action="inicioSesion.php">
        ...
        <p><input type="password" name="contrasena" value="" placeholder="Contraseña"></p>
        <p class="remember_me">
        </p>
    ...
    <div class="login-help">
      <p>¿Eres un cliente nuevo?<a id="link" href="registro.php">Empieza aquí.</a>
    </div>
  </section>
