...
<div id="caja" align="center">
           <?php
			  ...
			  if($num_total_registros>0){
				...
				$result = mysql_query("SELECT id, producto, precio FROM productos WHERE id_categoria=3 ORDER BY id DESC LIMIT ".$inicio.",".$TAMANO_PAGINA.""); 
