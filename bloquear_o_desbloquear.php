...
<p class="mtbBh">Bloquear o Desbloquear Clientes</p></br></br></br>
<?php
			  ...
			  if($num_total_registros>0){
				...
				$result = mysql_query("SELECT nombre, nombreUsuario, email, id_cliente, bloqueado FROM clientes ORDER BY id_cliente DESC LIMIT ".$inicio.",".$TAMANO_PAGINA.""); 
			  
				  if (mysql_num_rows($result)){ 
				 	
						echo "<table cellspacing=\"0\" style=\"font-size:14px; font-weight:normal;\" align=\"center\"> ";   
						echo "<tr id=\"titulos\" style=\"font-weight:bold;\"><td align=\"right\">Nombre</td><td align=\"center\">Nick</td><td align=\"center\">Email</td><td align=\"center\">Estado</td></tr>";
						...
						while ($row = @mysql_fetch_array($result)) {
							...
							if($bloqueado==false){
								...
								echo "<a style=\"color:red; font-weight:bold; font-size:16px;\" href=\"bloquear.php?id=".$id."\" >Bloquear";
				...
				echo "</a></td>";
								...
								echo "<a style=\"color:green; font-weight:bold; font-size:16px;\" href=\"desbloquear.php?id=".$id."\" >Desbloquear";
			  ...
			  echo "</tr>"; 
					...
					echo "<div id=\"enlaces\" style=\"position:absolute; top:430px; left:90px;\">";
					if ($total_paginas > 1) {
					   if ($pagina != 1)
