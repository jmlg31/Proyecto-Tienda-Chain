...
<div id="caja" align="center">
           <?php
			  ...
			  $sql="SELECT * FROM productos WHERE id_categoria=12";
			  $rs = mysql_query($sql);
			  ...
			  if($num_total_registros>0){
				...
				$result = mysql_query("SELECT id, producto, precio FROM productos WHERE id_categoria=12 ORDER BY id DESC LIMIT ".$inicio.",".$TAMANO_PAGINA.""); 
...
<ul class="submenu">
    ...
    <li><a href="sillones">Sillones</a></li>
...
<div id="hijo6">
<div id="pie">
<a href="condicionesGenerales.php">Condiciones Generales</a></div><div id="pie2"><a href="politicaPrivacidad.php">Política de Privacidad</a></div><div id="pie3"><a href="informacionContacto.php">Información de Contacto</a>
</div>
<div id="pie4"><img id="copy" src="Imagenes/copyright-1.png" width="18" height="18"/><p id="txt">CHAIN S.L. Todos los derechos reservados. 2015</p>
</div>
</div>
