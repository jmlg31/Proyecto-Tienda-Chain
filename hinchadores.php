...
<p class="mtbBh">Hinchadores</p></br>
<div id="caja" align="center">
           <?php
			  ...
			  if($num_total_registros>0){
				...
				$result = mysql_query("SELECT id, producto, precio FROM productos WHERE id_categoria=5 ORDER BY id DESC LIMIT ".$inicio.",".$TAMANO_PAGINA.""); 
