...
<p class="mtbBh">Bicicletas MTB <img width="40" height="40" src="Imagenes/bh_logo[1].png"</img></p></br>
<div id="caja" align="center">
           <?php
			  ...
			  $sql="SELECT * FROM productos WHERE producto LIKE '%BH%' AND id_categoria=1";
			  $rs = mysql_query($sql);
			  ...
			  if($num_total_registros>0){
				...
				$result = mysql_query("SELECT id, producto, precio FROM productos WHERE producto LIKE '%BH%' AND id_categoria=1 ORDER BY id DESC LIMIT ".$inicio.",".$TAMANO_PAGINA.""); 
