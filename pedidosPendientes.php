...
<p class="mtbBh">Pedidos Pendientes</p></br>
<?php
			  ...
			  if($num_total_registros>0){
				...
				$result = mysql_query("SELECT id_pedido, id_cliente, fec_alta FROM pedidos ORDER BY id_pedido DESC LIMIT ".$inicio.",".$TAMANO_PAGINA.""); 
				  ...
				  if (mysql_num_rows($result)){ 
						...
						echo "<tr id=\"titulos\" style=\"font-weight:bold;\"><td align=\"center\">Estado</td><td align=\"center\">Id Pedido</td><td align=\"center\">Id Cliente</td><td align=\"center\">Fecha Pedido</td></tr>";
						...
						while ($row = @mysql_fetch_array($result)) {
							...
							$fecha=$row[2];
								...
								echo "<td align=\"center\" style=\"border-bottom: 25px solid transparent;\" align=\"center\"><img src=\"Imagenes/faq.png\" width=\"15\" height=\"15\"/></td>"; 
											
								echo "<td style=\"border-bottom: 25px solid transparent;\" align=\"center\">".$id_pedido."</td>"; 
								echo "<td style=\"border-bottom: 25px solid transparent;\" id=\"prod\" align=\"center\">".$id_cliente."</td><td style=\"border-bottom: 25px solid transparent;\" align=\"center\">".$fecha."</td>"; 
