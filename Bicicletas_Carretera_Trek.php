...
<p class="mtbBh">Bicicletas Carretera <img width="40" height="40" src="Imagenes/l72084-trek-logo-95843.png"</img></p></br>
<div id="caja" align="center">
           <?php
			  ...
			  $sql="SELECT * FROM productos WHERE producto LIKE '%Trek%' AND id_categoria=2";
			  $rs = mysql_query($sql);
			  ...
			  if($num_total_registros>0){
				...
				$result = mysql_query("SELECT id, producto, precio FROM productos WHERE producto LIKE '%Trek%' AND id_categoria=2 ORDER BY id DESC LIMIT ".$inicio.",".$TAMANO_PAGINA.""); 
