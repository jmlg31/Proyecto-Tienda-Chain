...
<p class="mtbBh">Transmición</p></br>
<div id="caja" align="center">
           <?php
			  ...
			  $sql="SELECT * FROM productos WHERE id_categoria=13";
			  $rs = mysql_query($sql);
			  ...
			  if($num_total_registros>0){
				...
				$result = mysql_query("SELECT id, producto, precio FROM productos WHERE id_categoria=13 ORDER BY id DESC LIMIT ".$inicio.",".$TAMANO_PAGINA.""); 
